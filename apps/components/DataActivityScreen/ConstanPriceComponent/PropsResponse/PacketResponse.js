...
const PacketResponse = ({item}) => {
  let { vtype, nominal, harga, ket } = item
  let { 
  ...
  return (
    <List>
      <Card style={lCardStyle}>
        <ListItem icon>
          <Body>
            <Text style={lTextStyle}>Kode</Text>
          </Body>
          <Right>
            <Text style={lPriceStyle}>{vtype}</Text>
          </Right>
        </ListItem>
        <ListItem icon>
          <Body>
